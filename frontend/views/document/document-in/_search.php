...
<?php
    $searchFields = array_merge(
        ...
        SearchFieldHelper::textField('executorName', 'Исполнитель', 'Исполнитель'),
        SearchFieldHelper::dropdownField('sendMethodName', 'Способ получения', 'Способ получения', Yii::$app->sendMethods->getList()),
        SearchFieldHelper::dropdownField('status', 'Статус документа', 'Статус документа', Yii::$app->documentStatus->getList())
    );
